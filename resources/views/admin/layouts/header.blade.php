        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('assets/theme/images/logo/neverdev_light_logo.png')  }}" alt="" height="45">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('assets/theme/images/logo/neverdev_light_logo.png')  }}" alt="" height="45">
                    </span>
                ...
                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ asset('assets/theme/images/logo/neverdev_dark_logo.png')  }}" alt="" height="45">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('assets/theme/images/logo/neverdev_dark_logo.png')  }}" alt="" height="45">
                    </span>
            ...
            <div class="dropdown d-inline-block">
               ...
               @endswitch
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a href="{{ route('admin.change-language', ['en']) }}" class="dropdown-item notify-item language" data-lang="en">
                        <img src="{{ asset('assets/admin/assets/images/flags/us.jpg') }}" alt="user-image" class="me-1"
                            height="12"> <span class="align-middle">English</span>
                    </a>
                    <!-- item-->
                    <a href="{{ route('admin.change-language', ['vi']) }}" class="dropdown-item notify-item language" data-lang="vi">
                        <img src="{{ asset('assets/admin/assets/images/flags/vietnam.png') }}" alt="user-image"
                            class="me-1" height="12"> <span class="align-middle">Vietnamese</span>
                    </a>
                </div>
            </div>

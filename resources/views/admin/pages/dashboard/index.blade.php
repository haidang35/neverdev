                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <img src="assets/admin/assets/images/users/avatar-1.jpg" alt=""
                                ...
                                <div class="tab-pane active" id="post-recent" role="tabpanel">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item py-3">
                                            <div class="d-flex">
                                                <div class="me-3">
                                                    <img src="assets/admin/assets/images/small/img-2.jpg" alt=""
                                                ...
                                                <div class="align-self-center overflow-hidden me-auto">
                                                    <div>
                                                        <h5 class="font-size-14 text-truncate"><a
                                                                href="javascript: void(0);" class="text-dark">Beautiful
                                        ...
                                        <li class="list-group-item py-3">
                                            <div class="d-flex">
                                                <div class="me-3">
                                                    <img src="assets/admin/assets/images/small/img-6.jpg" alt=""
                                                        class="avatar-md h-auto d-block rounded">
                                                </div>
                                                <div class="align-self-center overflow-hidden me-auto">
                                                    <div>
                                        ...
                                        <li class="list-group-item py-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="align-self-center overflow-hidden me-auto">
                                                    <div>
                                                        <h5 class="font-size-14 text-truncate"><a
                                                                href="javascript: void(0);" class="text-dark">Project
                                        ...
                                        <li class="list-group-item py-3">
                                            <div class="d-flex">
                                                <div class="me-3">
                                                    <img src="assets/admin/assets/images/small/img-1.jpg" alt=""
                                                        class="avatar-md h-auto d-block rounded">
                                                </div>
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item py-3">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar-xs">
                                                <img src="assets/admin/assets/images/users/avatar-2.jpg" alt=""
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 100px;"><img src="assets/admin/assets/images/small/img-2.jpg" alt=""
                                    ...
                                    <tr>
                                        <td><img src="assets/admin/assets/images/small/img-6.jpg" alt=""
                                                class="avatar-md h-auto d-block rounded"></td>
                                        <td>
                                            <h5 class="font-size-13 text-truncate mb-1"><a href="javascript: void(0);"
                                    ...
                                    <tr>
                                        <td><img src="assets/admin/assets/images/small/img-1.jpg" alt=""
                                                class="avatar-md h-auto d-block rounded"></td>
                                        <td>
                                            <h5 class="font-size-13 text-truncate mb-1"><a href="javascript: void(0);"
                                    ...
                                    <tr>
                                        <td><img src="assets/admin/assets/images/small/img-2.jpg" alt=""
                                                class="avatar-md h-auto d-block rounded"></td>
                                        <td>
                                            <h5 class="font-size-13 text-truncate mb-1"><a href="javascript: void(0);"

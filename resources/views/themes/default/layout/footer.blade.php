<footer class="site-footer">
    <div class="container">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="social-links-wrap flex">
                                <div class="social-links flex">
                                    <a href="#" aria-label="twitter link"><svg
                                    ...
                                    <a href="#"
                                        aria-label="facebook link"><svg xmlns="http://www.w3.org/2000/svg"
                                            width="24" height="24" viewBox="0 0 24 24">
                                            <path
                                                d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z">
                                            </path>
                                        </svg></a>
                                    <a href="#" aria-label="instagram link"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24">
                                            <path
                                    ...
                                    <a href="#" aria-label="github link"><svg xmlns="http://www.w3.org/2000/svg"
                                            width="24" height="24" viewBox="0 0 24 24">
                                            <path
        ...
        <div class="footer-bottom flex justify-space-between">
            <div class="copyright">
                &copy; 2021 <a href="#">NEVERDEV</a> - All right Reserved. Published with <a
                    href="{{ route('home') }}">Dang Jinner</a>
            </div>
        </div>
    </div>
</footer>